...
abstract class User
{
	 ...
	 *	userWrongSessions
	 */
	private static function exportUser($name, $email, $pass, $birth, $sex, int $privilege, $bin): void
	{
		$params = [
			":name" => $name,
			":email" => $email,
	...
	{				
		self::exportUser(
			...
			"male",
			0,
			(new ImageConverter("/var/www/html".APPROOT."/App/images/userMale.png"))->bin
		);
	}
}