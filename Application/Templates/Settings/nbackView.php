<script type="text/javascript">
	this.gameMode = <?php if($user->gameMode == 'Off') {echo 'false;';} else {echo 'true;';}?>
	this.trial_min = <?php echo $trial_min; ?>;
	this.seconds_min = 0.1;

	function Key_event_onuser_options(){
...
<p style="text-align:center">Choose your game mode</p>
...
<div class="n_back_options_values_container">
	<div class="number_input_container">
		...
		<input class="input" tabindex="-1" form="n_back_options_form" name="gameMode" id="_gameMode" type="text"  value="<?php echo $user->gameMode?>" readonly onwheel="ChangePositionValueInNBackOptions('-1', event)" autofocus/>
...
<div class="n_back_options_values_container">
	<div class="number_input_container">
		...
		<input class="input" tabindex="-1" form="n_back_options_form"   name="level" id="level" id="level" type="text" step="1" min="1" max="20" value="<?php echo round($user->level, 2)?>" readonly onwheel="ChangeNuberValue('-1',level, 0, event)" <?php if($user->gameMode == "Off") echo "style='color:#aaa'";?> />
...
<div class="n_back_options_values_container">
	<div class="number_input_container">
		...
		<input class="input" tabindex="-1" form="n_back_options_form"   name="seconds" id="seconds" type="text" step="0.1" min="0.1" max="5.0" value="<?php echo round($user->seconds, 2)?>" readonly onwheel="ChangeNuberValue('-1',seconds, 1, event)" />
...
<div class="n_back_options_values_container">
	<div class="number_input_container">
		...
		<input class="input" tabindex="-1" form="n_back_options_form"   name="trial" id="trial" type="text" step="5" min="0" max="60" value="<?php echo $user->trial - ($user->level * 5) - 20;?>" readonly onwheel="ChangeNuberValue('-1',trial, 0, event)"/>
...
<div class="n_back_options_values_container">
	<div class="number_input_container">
		<input tabindex="-1" form="n_back_options_form" tabindex="-1"  name="n_back_long" id="n_back_long" type="text"  value="<?php echo round($user->trial * $user->seconds)." s";?>" readonly/>
		<section ></section>
	</div>
</div>
<!-- eventLength>
<div class="n_back_options_values_container">
	<div class="number_input_container">
		...
		<input class="input" tabindex="-1" form="n_back_options_form"  name="eventLength" id="eventLength" type="text" step="0.005" min="0.005" max="4.955" value="<?php echo ($user->eventLength);?>" readonly onwheel="ChangeNuberValue('-1',eventLength, 3, event)"/>
...
<div class="n_back_options_values_container">
	<div class="number_input_container">
		...
		<input class="input" tabindex="-1" form="n_back_options_form"  name="color" id="color" type="text" value="<?php echo ($user->color);?>" readonly onwheel="ChangeColorValueInNBackOptions('-1',this, event)"/>
