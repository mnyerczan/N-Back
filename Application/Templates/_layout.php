...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="<?= RELPATH ?><?=APPLICATION?>Style/common-new.css?v=<?= CURRENT_TIMESTAMP ?>" />
    <link rel="stylesheet" type="text/css" href="<?= RELPATH ?><?=APPLICATION?>Style/white.css?v=<?= CURRENT_TIMESTAMP ?>" />
    <link rel="stylesheet" type="text/css" href="<?= RELPATH ?><?=APPLICATION?>Style/black.css?v=<?= CURRENT_TIMESTAMP ?>" />  
    <script src="<?= RELPATH ?><?=APPLICATION?>Scripts/helperFunctions.js"></script>
