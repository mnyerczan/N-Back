...
<!--[if gt IE 8]><!--> <html class="no-js"> <!--<![endif]-->
	<head>
		...
		<link rel="stylesheet" type="text/css" href="<?=APPLICATION?>Style/style_white.css" />
		<link rel="stylesheet" type="text/css" href="<?=APPLICATION?>Style/style_black.css" />		
		<link rel="stylesheet" type="text/css" href="<?=APPLICATION?>Style/common.css" />
	...
	<body  class="main_body" id="main" tabindex="-1">
        ...
        <![endif]-->
		<!-- Header -->
		<?php require_once APPLICATION."Templates/Main/headerView.php";  ?>
		<!-- Info label -->
		<?php //require_once('info_label.php');?>
		<!-- Nav bar -->
		<?php require_once APPLICATION.'Templates/Main/navbarView.php'; ?>
		<!-- Main Page -->
		<div class="main_page" id="main_page">
			...
			<main id="main_page_center_box" unselectable="on" tabindex="-1" <?= @$_GET['nb_common'] == 1 ? 'style="pointer-events: none;"' : ""?>>
				...
				<?php require_once APPLICATION."Templates/Main/{$view}View.php";
/* 
switch($page)
{
